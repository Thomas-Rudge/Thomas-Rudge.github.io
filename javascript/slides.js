...
var imageToggle = function(direction) {
   ...
   expandImageView(null, nextImageInt, false);
};
...
var expandImageView = function(e, imageId) {
   e = e || window.event;
   if (e) {
      e.stopPropagation();
   }
   ...
   imageObj.onclick = function() { contractImageView(null, imageId, false); };
...
var contractImageView = function(e, imageId, resized) {
   e = e || window.event;
   if (e) {
      e.stopPropagation();
   }
   ...
   //activeId.onclick = null;
   activeImg.onclick = function() { expandImageView(null, imageId, false); };
